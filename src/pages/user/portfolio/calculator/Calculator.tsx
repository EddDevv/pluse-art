...
import { AccountsForRdEnum, AccountsFullEnum, speedMaxEnum } from "../../../../assets/consts/consts";
import { Radio, RadioGroup, RangeSlider, RangeSliderFilledTrack, RangeSliderThumb, RangeSliderTrack, Stack } from "@chakra-ui/react";
...
const Calculator = ({ portfolioId, investPlan, refresh, setRefresh }: PropsType) => {
    ...
    const getIncomePerMonth = () => {
        ...
        let sum = (investPlan.percentPerMonth + investPlan.speedPercent * getSpeed()) * totalPrice;
        return sum;
    }
        ...
        <>
            <div className={`${styles.paper}`}>
                ...
                <div className={styles.inputs_box}>
                    ...
                    <div className={styles.flex}>
                        <div className={styles.min_max}>{value[portfolioId].minSum?.toLocaleString()} USD</div>
                        <div className={styles.min_max}>{value[portfolioId]?.maxSum?.toLocaleString()} USD</div>
                    </div>
                    ...
                    <div className={styles.range}>
                        ...
                        >
                            <RangeSliderTrack
                                style={{ height: "7px", borderRadius: "3px" }}
                            >
                            ...
                            <Stack direction='row' gap={45}>
                                {["no", "1", "2", "3", "4", "5"].map(elem => (
                                    <Radio
                                        value={elem}
                                        color={"teal.500"}
                                        isDisabled={elem === "no" || +elem <= speedMaxEnum[portfolioId] ? false : true}
                                    >
                                        {elem === "no"
                                            ? t("DopItems.no")
                ...
                <div className={styles.sum_box}>
                        ...
                        <div>
                            <b className={styles.big_text}>
                                {isInsure === "true" && totalPrice ?
                                    getNumWithoutZeroToFixedN(totalPrice * investPlan.insurancePrice, 2)
                                    : 0
                                }
                            </b>
                            &nbsp; USD
                    ...
                    <div className={styles.sum_item}>
                        ...
                        <div>
                            <b className={styles.big_text}>
                                {totalPrice && getNumWithoutZeroToFixedN(getSpeedSumPercent() * totalPrice, 2)}
                            </b>
                            &nbsp; USD
                        </div>
                    </div>
                ...
                <div className={styles.footer_box}>
                    ...
                    <div className={`${styles.footer_item}  `}>
                        <button className="dark_orange_button_w100"
            ...
            >
                <div style={{ color: "#008080", textAlign: "center", marginBottom: "30px" }}>
                    <b className={styles.big_text}>
                        {getNumWithoutZeroToFixedN(getTotalSum(), 2)}
                    </b>
                    &nbsp; USD
                ...
                <div style={{ width: "100%", paddingBottom: "20px", textAlign: "center", color: "#e73351", fontWeight: "bold" }}>
