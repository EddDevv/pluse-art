...
export const usePaginationNew = ({ contentPerPage, count }: any) => {
  ...
  const [pageCount, setPageCount] = useState(Math.ceil(count / contentPerPage));
  ...
  const setPageSAFE = (num: number) => {
    // console.log("setPageSAFE num", num);
    // console.log("setPageSAFE pageCount", pageCount);
